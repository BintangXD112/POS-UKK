...
import { BarChart2, FileDown, TrendingDown, Receipt, Calculator } from 'lucide-react';
                        ...
                        <table className="w-full text-sm">
                            ...
                            {localPembelian.length > 0 && (
                                <tfoot className="border-t bg-muted/10">
                                    <tr>
                                        <td colSpan={5} className="px-5 py-4 text-sm font-semibold text-right text-muted-foreground uppercase tracking-wide">Total Keseluruhan:</td>
