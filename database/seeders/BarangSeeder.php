...
class BarangSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $barang = [
            ...
            [
                'id_sekolah' => 1, 'barcode' => 'MNM001', 'nama' => 'Aqua Botol 600ml',
            ...
            [
                'id_sekolah' => 1, 'barcode' => 'MNM002', 'nama' => 'Teh Botol Sosro 450ml',
                'id_kategori' => 1, 'id_kelompok_kategori' => 1, 'id_supplier' => 1,
                'satuan' => 'botol', 'harga_beli' => 4000, 'harga_jual' => 6000, 'stok' => 80,
                'is_active' => 1, 'created_by' => 1,
            ],
            [
                'id_sekolah' => 1, 'barcode' => 'MNM003', 'nama' => 'Pocari Sweat 500ml',
            ...
            [
                'id_sekolah' => 1, 'barcode' => 'ATK001', 'nama' => 'Pena Pilot G-2 (Hitam)',
                'id_kategori' => 5, 'id_kelompok_kategori' => 2, 'id_supplier' => 4,
                'satuan' => 'pcs', 'harga_beli' => 5000, 'harga_jual' => 8000, 'stok' => 60,
                'is_active' => 1, 'created_by' => 1,
            ],
            [
                'id_sekolah' => 1, 'barcode' => 'ATK002', 'nama' => 'Pensil 2B Staedtler',
                'id_kategori' => 5, 'id_kelompok_kategori' => 2, 'id_supplier' => 4,
            ...
            [
                'id_sekolah' => 1, 'barcode' => 'ATK003', 'nama' => 'Buku Tulis 58 Lembar',
                'id_kategori' => 6, 'id_kelompok_kategori' => 2, 'id_supplier' => 2,
                'satuan' => 'buku', 'harga_beli' => 3500, 'harga_jual' => 6000, 'stok' => 200,
                'is_active' => 1, 'created_by' => 1,
            ],
            [
                'id_sekolah' => 1, 'barcode' => 'ATK004', 'nama' => 'Kertas HVS A4 80gr (rim)',
                'id_kategori' => 6, 'id_kelompok_kategori' => 2, 'id_supplier' => 2,
                'satuan' => 'rim', 'harga_beli' => 45000, 'harga_jual' => 60000, 'stok' => 30,
                'is_active' => 1, 'created_by' => 1,
            ],
            // Penghapus & Tip-X (kelompok 2, kategori 7)
            [
                'id_sekolah' => 1, 'barcode' => 'ATK005', 'nama' => 'Penghapus Faber-Castell',
            ...
            [
                'id_sekolah' => 1, 'barcode' => 'ELK001', 'nama' => 'Screen Protector Universal',
            ...
            [
                'id_sekolah' => 1, 'barcode' => 'ELK002', 'nama' => 'Kabel Data Type-C 1m',
            ...
            [
                'id_sekolah' => 1, 'barcode' => 'PRL001', 'nama' => 'Sabun Mandi Lifebuoy 90gr',
                'id_kategori' => 10, 'id_kelompok_kategori' => 4, 'id_supplier' => 1,
                'satuan' => 'pcs', 'harga_beli' => 3000, 'harga_jual' => 5000, 'stok' => 50,
                'is_active' => 1, 'created_by' => 1,
            ],
            [
                'id_sekolah' => 1, 'barcode' => 'PRL002', 'nama' => 'Tissue Facial Softex 100s',
                'id_kategori' => 10, 'id_kelompok_kategori' => 4, 'id_supplier' => 1,
